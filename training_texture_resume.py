...
def train_patch():
    ...
    # 尝试加载最新的检查点
    checkpoint = load_latest_checkpoint(f'{pargs.method}_{pargs.suffix}')
    ...
    for epoch in range(start_epoch, args.n_epochs + 1):
        ...
        if epoch % 20 == 0:
            ...
            save_checkpoint(checkpoint_state, f'{pargs.method}_{pargs.suffix}_epoch{epoch}.pth')
...
def train_z(gen=None):
    ...
    for epoch in range(start_epoch, args.z_epochs + 1):
        ...
        if epoch % 20 == 0:
            ...
            save_checkpoint(checkpoint_state, f'z_epoch{epoch}.pth')
